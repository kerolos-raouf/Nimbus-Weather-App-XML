...
object Constants
{
    ...
    const val COUNTRY_SEARCH_BASE_URL = "https://api.api-ninjas.com/v1/"
    ...
    const val ALERT_ACTION_START_ALARM = "com.example.START_ALARM"
    const val ALERT_ACTION_STOP_ALARM = "com.example.STOP_ALARM"
